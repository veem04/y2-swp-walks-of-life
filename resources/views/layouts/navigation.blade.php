<nav x-data="{ open: false }" class="bg-my-green border-b border-gray-100">
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="shrink-0 flex items-center text-white font-light text-2xl">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('journeys.index')" :active="request()->routeIs('journeys.*')">
                        {{ __('Journeys') }}
                    </x-nav-link>
